...
public class M_Order01 extends BaseDAO implements I_Order01, I_BaseTable, I_BaseReference {
	...
	public void createTable(Environment env) {
		...
		table.addColumnData(env, COL_ID_ORDER_ID, COL_NAME_ORDER_ID, TABLE_ID_ORD_ORDER,
				R_INT, COL_COMMENT_ORDER_ID, COL_DESCRIPTION_ORDER_ID);
		table.addColumnData(env, COL_ID_ORDER_DATE, COL_NAME_ORDER_DATE, TABLE_ID_ORD_ORDER,
				R_DATE, COL_COMMENT_ORDER_DATE, COL_DESCRIPTION_ORDER_DATE);
		table.addColumnData(env, COL_ID_PARTNER_NAME, COL_NAME_PARTNER_NAME, TABLE_ID_ORD_ORDER,
				R_STRING, COL_COMMENT_PARTNER_NAME, COL_DESCRIPTION_PARTNER_NAME);
		table.addColumnData(env, COL_ID_PRODUCT_NAME, COL_NAME_PRODUCT_NAME, TABLE_ID_ORD_ORDER,
				R_STRING, COL_COMMENT_PRODUCT_NAME, COL_DESCRIPTION_PRODUCT_NAME);
		table.addColumnData(env, COL_ID_ORDER_NUMBER, COL_NAME_ORDER_NUMBER, TABLE_ID_ORD_ORDER,
				R_NUMBER, COL_COMMENT_ORDER_NUMBER, COL_DESCRIPTION_ORDER_NUMBER);
		table.addColumnData(env, COL_ID_ORDER_AMOUNT, COL_NAME_ORDER_AMOUNT, TABLE_ID_ORD_ORDER,
				R_NUMBER, COL_COMMENT_ORDER_AMOUNT, COL_DESCRIPTION_ORDER_AMOUNT);
	}
