...
//	public final int TABLE_ID_ORDER = 1101;	// TODO 受注情報のテーブル情報IDは固定 2024/11/22
	...
	public final String COL_ALTER_ORDER_DATE = "ALTER TABLE" + SP + TABLE_NAME_ORD_ORDER + SP
	...
	public final String COL_ALTER_PARTNER_NAME = "ALTER TABLE" + SP + TABLE_NAME_ORD_ORDER + SP
	...
	public final String COL_ALTER_PRODUCT_NAME = "ALTER TABLE" + SP + TABLE_NAME_ORD_ORDER + SP
	...
	public final String COL_ALTER_ORDER_NUMBER = "ALTER TABLE" + SP + TABLE_NAME_ORD_ORDER + SP
	...
	public final String COL_ALTER_ORDER_AMOUNT = "ALTER TABLE" + SP + TABLE_NAME_ORD_ORDER + SP
			+ "ADD" + SP + COL_NAME_ORDER_AMOUNT + SP + "DECIMAL(20,0) DEFAULT 0" + SP
			+ "COMMENT" + SP + SQ + COL_COMMENT_ORDER_AMOUNT + SQ + SP;
	
	// SQL関係
	/** SQL : 追加用 */
	public final String SQL_INSERT_ORDER = "INSERT INTO" + SP + TABLE_NAME_ORD_ORDER + " ("
